...
describe('GroupsView — les gestes suivent la règle du serveur (oto#210)', () => {
  it.each([
    ['org_admin', 'member', 'org_admin', ['New', 'Connectors', 'Edit', 'Delete']],
    ...
    ['super_admin', 'super_admin', null, ['New', 'Connectors', 'Edit', 'Delete']],
...
describe('GroupsView — en consultation, aucun geste (oto#211)', () => {
  it.each([
    ...
    expect(await boutons(role, orgRole, false)).toEqual(['New', 'Connectors', 'Edit', 'Delete'])
