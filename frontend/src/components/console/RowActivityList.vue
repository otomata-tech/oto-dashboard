...
// badge d'origine — la `source` du journal des révisions quand elle est servie (oto#273).
// Sorti de RowDrawer tel quel (oto#213), qui dépassait 500 lignes.
//
...
import { actorOf, originLabel, originTone, whenOf } from '@/lib/rowActivity'
